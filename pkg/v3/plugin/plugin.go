...
import (
	...
	"github.com/goplugin/plugin-automaton/pkg/v3/config"
	"github.com/goplugin/plugin-automaton/pkg/v3/coordinator"
	"github.com/goplugin/plugin-automaton/pkg/v3/flows"
	"github.com/goplugin/plugin-automaton/pkg/v3/plugin/hooks"
	"github.com/goplugin/plugin-automaton/pkg/v3/runner"
	"github.com/goplugin/plugin-automaton/pkg/v3/service"
	"github.com/goplugin/plugin-automaton/pkg/v3/stores"
	"github.com/goplugin/plugin-automaton/pkg/v3/telemetry"
