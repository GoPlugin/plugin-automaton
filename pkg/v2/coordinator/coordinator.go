...
import (
	...
	"github.com/goplugin/plugin-automaton/pkg/util"
	ocr2keepers "github.com/goplugin/plugin-automaton/pkg/v2"
)
...
//go:generate mockery --name LogProvider --srcpkg "github.com/goplugin/plugin-automaton/pkg/v2/coordinator" --case underscore --filename log_provider.generated.go
...
//go:generate mockery --name Encoder --srcpkg "github.com/goplugin/plugin-automaton/pkg/v2/coordinator" --case underscore --filename encoder.generated.go
